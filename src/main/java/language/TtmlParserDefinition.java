...
import language.parser.TtmlParser;
import language.psi.TtmlFile;
import language.psi.TtmlTypes;
import org.jetbrains.annotations.NotNull;

public class TtmlParserDefinition implements ParserDefinition {

    public static final IFileElementType FILE = new IFileElementType(TtmlLanguage.INSTANCE);
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new TtmlFile(viewProvider);
    }
